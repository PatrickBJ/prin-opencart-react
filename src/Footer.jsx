...
export const Footer = () => (
    <div className="footer full-width">
        <div className="pattern" style={{ backgroundColor: 'white', backgroundImage: `url(${FooterImage})`, backgroundPosition: 'bottom center', backgroundRepeat: 'no-repeat' }}>
            <div className="container">
                <div className="advanced-grid advanced-grid-20596476 border-top responsive-margin-top-0" style={{ marginTop: '-40px', marginBottom: '0px', width: '1519px', left: '-189.6px' }}>
                    <div className="container" style={{ paddingLeft: '189.6px', paddingRight: '189.6px' }}>
