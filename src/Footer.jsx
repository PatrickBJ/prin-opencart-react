                            ...
                            <div style={{ paddingTop: '0px', paddingLeft: '0px', paddingBottom: '0px', paddingRight: '0px' }}>
                                <div className="row">
                                    <div className="col-sm-3">
                                        <div style={{ height: '13px' }} /><div className="strip-line" /><div className="row" style={{ clear: 'both' }}><div className="col-sm-12"><ul><li><Link to="http://opencart2.printastico.com.br/a-empresa">A Empresa</Link></li><li><Link to="http://opencart2.printastico.com.br/qualidade-e-tecnologia">Qualidade e Tecnologia</Link></li><li><Link to="http://opencart2.printastico.com.br/meio-ambiente">Meio Ambiente</Link></li><li><Link to="http://opencart2.printastico.com.br/privacidade-e-seguranca">Privacidade e Segurança</Link></li><li><Link to="http://opencart2.printastico.com.br/termos-de-uso">Termos de Uso</Link></li><li><Link to="http://opencart2.printastico.com.br/contato-institucional">Contato Institucional</Link></li><li><Link to="http://opencart2.printastico.com.br/international-contact">International Contact</Link></li></ul></div></div>
                                    </div>
                                    <div className="col-sm-3">
